...
export default function Restaurant() {
  ...
  return (
    <div className="w-full min-h-screen pt-20 pb-20 px-6 flex flex-col items-center">
      ...
      <section className="w-full max-w-[1200px] flex flex-col items-center" style={{ marginBottom: '150px' }}>
      ...
      <section id="menu-section" className="w-full max-w-[1000px] mb-30">
        ...
        >
          <div className="flex flex-col items-center mb-12">
            ...
            <div className="w-24 h-[3px] bg-linear-to-r from-transparent via-[#8ccb8c] to-transparent rounded-full" />
          </div>
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-24">
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-px bg-linear-to-b from-transparent via-[#c4dbc4] to-transparent -translate-x-1/2" />
          ...
          <div className="flex flex-col items-center">
            ...
            >
              <span className="absolute inset-0 bg-linear-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:animate-shine" />
      ...
      {isBookingVisible && (
        <section id="booking-section" className="w-full max-w-[800px] mb-30 flex flex-col items-center">
          ...
          >
            <div className="absolute top-0 left-0 w-full h-3 bg-linear-to-r from-[#1b4332] via-[#8ccb8c] to-[#1b4332]" />
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#1a503a] mb-8 text-center" style={{ fontFamily: "'Dancing Script', cursive", fontSize: '3.5rem', padding: '15px', marginBottom: '20px' }}>
              Reserve Your Experience
            </h2>
            {bookingStatus === 'success' ? (
              <div className="text-center p-8 bg-[#eef5eb] rounded-3xl border border-[#8ccb8c]" style={{ padding: '20px', margin: '15px' }}>
                <Leaf className="mx-auto text-[#2D7A4F] mb-4" size={48} />
                <h3 className="text-2xl font-bold text-[#1b4332] mb-2" style={{ padding: '7px' }}>Table Confirmed!</h3>
                <p className="text-[#2D5A27]" style={{ padding: '15px' }}>We look forward to hosting you in nature.</p>
                <button
                  onClick={() => {
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <input required name="name" value={formData.name} onChange={handleInputChange} type="text" style={{ padding: '15px' }} placeholder="Full Name" className="w-full px-6 py-4 rounded-full bg-[#f0f7f0] border border-[#d8e8d8] text-[#1b4332] focus:outline-none focus:ring-2 focus:ring-[#8ccb8c] font-medium" />
                  <input required name="email" value={formData.email} onChange={handleInputChange} type="email" style={{ padding: '15px' }} placeholder="Email Address" className="w-full px-6 py-4 rounded-full bg-[#f0f7f0] border border-[#d8e8d8] text-[#1b4332] focus:outline-none focus:ring-2 focus:ring-[#8ccb8c] font-medium" />
                  <input required name="phone" value={formData.phone} onChange={handleInputChange} type="tel" style={{ padding: '15px' }} placeholder="Phone Number" className="w-full px-6 py-4 rounded-full bg-[#f0f7f0] border border-[#d8e8d8] text-[#1b4332] focus:outline-none focus:ring-2 focus:ring-[#8ccb8c] font-medium" />
                  <input required name="guests" value={formData.guests} onChange={handleInputChange} type="number" min="1" style={{ padding: '15px' }} placeholder="Number of Guests" className="w-full px-6 py-4 rounded-full bg-[#f0f7f0] border border-[#d8e8d8] text-[#1b4332] focus:outline-none focus:ring-2 focus:ring-[#8ccb8c] font-medium" />
                  <input required name="date" value={formData.date} onChange={handleInputChange} type="date" style={{ padding: '10px' }} className="w-full px-6 py-4 rounded-full bg-[#f0f7f0] border border-[#d8e8d8] text-[#1b4332] focus:outline-none focus:ring-2 focus:ring-[#8ccb8c] font-medium" />
                  <input required name="time" value={formData.time} onChange={handleInputChange} type="time" style={{ padding: '10px' }} className="w-full px-6 py-4 rounded-full bg-[#f0f7f0] border border-[#d8e8d8] text-[#1b4332] focus:outline-none focus:ring-2 focus:ring-[#8ccb8c] font-medium" />
                </div>
                <textarea name="special_requests" value={formData.special_requests} onChange={handleInputChange} style={{ padding: '15px', marginTop: '15px', marginBottom: '15px' }} placeholder="Special Requests (Optional)" rows="3" className="w-full px-6 py-4 rounded-3xl bg-[#f0f7f0] border border-[#d8e8d8] text-[#1b4332] focus:outline-none focus:ring-2 focus:ring-[#8ccb8c] font-medium"></textarea>
                <button disabled={bookingStatus === 'submitting'} type="submit" style={{ padding: '15px' }} className="w-full py-4 bg-[#1b4332] text-white rounded-full font-bold text-lg hover:bg-[#2D7A4F] transition-colors shadow-lg">
